...
exports.addRecord = async(req, res) => {
    let {contributor, content, lat, lng, email} = req.body;
    // let currTime = new Date().toISOString();
    console.log('INSERT INTO "tblRecord"(contributor, content, lat, lng, email) VALUES ($1, $2, $3, $4, $5)',
        [contributor, content, lat, lng, email]);
    let {recordRows} = await db.query(
        'INSERT INTO "tblRecord"(contributor, content, lat, lng, email) VALUES ($1, $2, $3, $4, $5)',
        [contributor, content, lat, lng, email]
    )
    ...
    res.status(200).send({
        ...
        body: {
            record: {contributor, content, lat, lng, email}
        }
    })
};